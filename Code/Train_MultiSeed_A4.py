# -*- coding: utf-8 -*-
"""
Multi-Seed Training Script — FA-LSTM A4: w/o Prior MLP
======================================================
Ablation: use_lstm_prior=False  (LSTM init state from zero, not from fixed features)
Output: models/FA-LSTM_A4/seed_{SEED}/  and  logs/FA-LSTM_A4/seed_{SEED}/

Usage:  python Code/Train_MultiSeed_A4.py
"""
...
# =============================================================================
# Paper ablation A4: w/o Prior MLP (LSTM initial state)
# 论文消融 A4: 去掉 Prior MLP，LSTM 初始状态从零开始
# =============================================================================
MODEL_VERSION = "FA-LSTM_A4"
...
V2F_CONFIG = dict(
    ...
    # ── A4: w/o Prior MLP ──
    use_feature_mhsa=True, use_attn_pool=True, use_lstm_prior=False,
