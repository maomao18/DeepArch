# -*- coding: utf-8 -*-
"""
Multi-Seed Training Script — FA-LSTM A6: w/o Multi-Head Output
==============================================================
Ablation: use_multihead_outputs=False
Output: models/FA-LSTM_A6/seed_{SEED}/  and  logs/FA-LSTM_A6/seed_{SEED}/

Usage:  python Code/Train_MultiSeed_A6.py
"""
...
# =============================================================================
# Paper ablation A6: w/o Multi-Head Output
# 论文消融 A6: 去掉 Multi-Head Output
# =============================================================================
MODEL_VERSION = "FA-LSTM_A6"
...
V2F_CONFIG = dict(
    ...
    # ── A6: w/o Multi-Head Output ──
    use_feature_mhsa=True, use_attn_pool=True, use_lstm_prior=True,
    use_multihead_outputs=False, use_film=True, use_state_residual=True,
