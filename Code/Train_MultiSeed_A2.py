# -*- coding: utf-8 -*-
"""
Multi-Seed Training Script — FA-LSTM A2: w/o Attention Pooling
==============================================================
Ablation: use_attn_pool=False  (MHSA still ON)
Output: models/FA-LSTM_A2/seed_{SEED}/  and  logs/FA-LSTM_A2/seed_{SEED}/

Usage:  python Code/Train_MultiSeed_A2.py
"""
...
# =============================================================================
# Paper ablation A2: w/o Attention Pooling
# 论文消融 A2: 去掉 AttnPool，退化为 mean pooling
# =============================================================================
MODEL_VERSION = "FA-LSTM_A2"
SEEDS: List[int] = [618]
...
V2F_CONFIG = dict(
    ...
    # ── A2: w/o Attention Pooling ──
    use_feature_mhsa=True, use_attn_pool=False, use_lstm_prior=True,
