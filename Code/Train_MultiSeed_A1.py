# -*- coding: utf-8 -*-
"""
Multi-Seed Training Script — FA-LSTM A1: w/o Feature Attention
==============================================================
Ablation: use_feature_mhsa=False  (AttnPool still ON)
Output: models/FA-LSTM_A1/seed_{SEED}/  and  logs/FA-LSTM_A1/seed_{SEED}/

Usage:  python Code/Train_MultiSeed_A1.py
"""
...
# =============================================================================
# Paper ablation A1: w/o Feature Attention (MHSA)
# 论文消融 A1: 去掉特征自注意力，保留 AttnPool
# =============================================================================
MODEL_VERSION = "FA-LSTM_A1"
SEEDS: List[int] = [618]
...
V2F_CONFIG = dict(
    ...
    # ── A1: w/o Feature Attention ──
    use_feature_mhsa=False, use_attn_pool=True, use_lstm_prior=True,
