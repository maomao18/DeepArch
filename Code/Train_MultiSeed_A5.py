# -*- coding: utf-8 -*-
"""
Multi-Seed Training Script — FA-LSTM A5: w/o State Residual
===========================================================
Ablation: use_state_residual=False
Output: models/FA-LSTM_A5/seed_{SEED}/  and  logs/FA-LSTM_A5/seed_{SEED}/

Usage:  python Code/Train_MultiSeed_A5.py
"""
...
# =============================================================================
# Paper ablation A5: w/o State Residual
# 论文消融 A5: 去掉 State Residual connection
# =============================================================================
MODEL_VERSION = "FA-LSTM_A5"
...
V2F_CONFIG = dict(
    ...
    # ── A5: w/o State Residual ──
    use_feature_mhsa=True, use_attn_pool=True, use_lstm_prior=True,
    use_multihead_outputs=True, use_film=True, use_state_residual=False,
